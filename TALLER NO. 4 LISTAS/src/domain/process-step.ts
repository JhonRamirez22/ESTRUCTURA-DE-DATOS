/** Swimlanes from the diagram. */
export type Lane = 'Customer' | 'Waiter' | 'Kitchen' | 'Cashier';

/** A step in the order service process. */
export interface ProcessStep {
  id: string;
  lane: Lane;
  action: string;
  description: string;
  /** IDs of steps that must be completed before this one can execute. */
  dependsOn: string[];
}
...
export const LANES: Lane[] = ['Customer', 'Waiter', 'Kitchen', 'Cashier'];
