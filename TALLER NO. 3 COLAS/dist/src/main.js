...
editor.onSnapshot(() => {
    ui.updateUndoRedoButtons(editor.canUndo(), editor.canRedo(), editor.getUndoCount(), editor.getRedoCount());
});
// Botones undo/redo
