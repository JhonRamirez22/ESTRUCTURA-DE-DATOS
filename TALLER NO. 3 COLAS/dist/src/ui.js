...
export function createUI() {
     ...
     */
    function updateUndoRedoButtons(canUndo, canRedo, undoCountValue, redoCountValue) {
     ...
     */
    function createJobCard(job, isFront) {
     ...
     */
    function updateQueueBadge(count, max = MAX_QUEUE) {
